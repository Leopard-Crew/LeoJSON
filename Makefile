...
bench-gcc40: $(BUILD_DIR)
	$(CC40) $(COMMON_FLAGS) 1000 4 5 20 21 24 27 30 44 46 109 110 115 136 147 998 1000 1002 1004OPTFLAGS) 1000 4 5 20 21 24 27 30 44 46 109 110 115 136 147 998 1000 1002 1004BENCH_SRC) $(JSONKIT_SRC) $(FOUNDATION_FLAGS) \
		-o $(BUILD_DIR)/leojson_jsonkit_bench_gcc40

bench-gcc42: $(BUILD_DIR)
	$(CC42) $(COMMON_FLAGS) 1000 4 5 20 21 24 27 30 44 46 109 110 115 136 147 998 1000 1002 1004OPTFLAGS) 1000 4 5 20 21 24 27 30 44 46 109 110 115 136 147 998 1000 1002 1004BENCH_SRC) $(JSONKIT_SRC) $(FOUNDATION_FLAGS) \
...
$(LEOJSON_OBJ_GCC40): $(LEOJSON_SRC) sources/LeoJSON/LeoJSON.h | $(BUILD_DIR)
	$(CC40) $(COMMON_FLAGS) 1000 4 5 20 21 24 27 30 44 46 109 110 115 136 147 998 1000 1002 1004OPTFLAGS) -c $(LEOJSON_SRC) -o $@

$(JSONKIT_OBJ_GCC40): $(JSONKIT_SRC) vendor/JSONKit/JSONKit.h | $(BUILD_DIR)
	$(CC40) $(COMMON_FLAGS) 1000 4 5 20 21 24 27 30 44 46 109 110 115 136 147 998 1000 1002 1004OPTFLAGS) -c $(JSONKIT_SRC) -o $@

$(LEOJSON_OBJ_GCC42): $(LEOJSON_SRC) sources/LeoJSON/LeoJSON.h | $(BUILD_DIR)
	$(CC42) $(COMMON_FLAGS) 1000 4 5 20 21 24 27 30 44 46 109 110 115 136 147 998 1000 1002 1004OPTFLAGS) -c $(LEOJSON_SRC) -o $@

$(JSONKIT_OBJ_GCC42): $(JSONKIT_SRC) vendor/JSONKit/JSONKit.h | $(BUILD_DIR)
	$(CC42) $(COMMON_FLAGS) 1000 4 5 20 21 24 27 30 44 46 109 110 115 136 147 998 1000 1002 1004OPTFLAGS) -c $(JSONKIT_SRC) -o $@
...
api-smoke-lib-gcc40: lib-gcc40
	$(CC40) $(COMMON_FLAGS) 1000 4 5 20 21 24 27 30 44 46 109 110 115 136 147 998 1000 1002 1004OPTFLAGS) 1000 4 5 20 21 24 27 30 44 46 109 110 115 136 147 998 1000 1002 1004API_SMOKE_SRC) $(BUILD_DIR)/libLeoJSON_gcc40.a $(FOUNDATION_FLAGS) \
		-o $(BUILD_DIR)/leojson_api_smoke_lib_gcc40

api-smoke-lib-gcc42: lib-gcc42
	$(CC42) $(COMMON_FLAGS) 1000 4 5 20 21 24 27 30 44 46 109 110 115 136 147 998 1000 1002 1004OPTFLAGS) 1000 4 5 20 21 24 27 30 44 46 109 110 115 136 147 998 1000 1002 1004API_SMOKE_SRC) $(BUILD_DIR)/libLeoJSON_gcc42.a $(FOUNDATION_FLAGS) \
