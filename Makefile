...
api-smoke-lib-gcc40: lib-gcc40
	$(CC40) $(COMMON_FLAGS) -O2 $(API_SMOKE_SRC) $(BUILD_DIR)/libLeoJSON_gcc40.a $(FOUNDATION_FLAGS) \
		-o $(BUILD_DIR)/leojson_api_smoke_lib_gcc40

api-smoke-lib-gcc42: lib-gcc42
	$(CC42) $(COMMON_FLAGS) -O2 $(API_SMOKE_SRC) $(BUILD_DIR)/libLeoJSON_gcc42.a $(FOUNDATION_FLAGS) \
